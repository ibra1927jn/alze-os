...
## Errores registrados
- [2026-04-23] | kernel/sched.c | KASSERT(init_task != 0) en sched_init fallaba build con -Werror=implicit-function-declaration porque faltaba #include "panic.h" | Se agrego #include "panic.h" al bloque de includes
